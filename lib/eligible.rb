...
module Eligible
  ...
  def self.valid_fingerprint?(received)
  	puts "valid finger?", fingerprints.include?(OpenSSL::Digest::SHA1.hexdigest(received.to_der)), fingerprints, OpenSSL::Digest::SHA1.hexdigest(received.to_der)
